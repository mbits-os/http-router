/*
  ...
  Author: 'user1095108'
  (http://codereview.stackexchange.com/users/15768/user1095108)
...
public:
	...
	template <
	    ...
	    typename = typename ::std::enable_if<
	        !::std::is_same<delegate, typename ::std::decay<T>::type>{}>::type>
	delegate(T&& f)
...
private:
	...
	template <typename T>
	static typename ::std::enable_if<!(is_member_pair<T>::value ||
